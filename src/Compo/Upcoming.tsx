...
import Imgmain from '../assets/gabbar1.jpeg'
...
<Box>
    ...
    <Flex>
    <Box maxWidth='300' marginTop='20'marginLeft='20' border='none' boxShadow='0px 0px 5px 0px gray; 0px 0px 0px 0px gray' borderRadius='9px' py='10' position='absolute' top='200' zIndex='200' backgroundImage={Imgmain}>
